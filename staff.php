...
<body>
    ...
    <div class="adminmain">
        <div class="sidebar">
            ...
            <div class="menu">
                <div class="item" onclick="clickMenu('order')"><a><i class="fa-solid fa-user-pen"></i></i>ORDER</a></div>
                ...
                <div class="item" onclick="clickMenu('order_history')"><a><i class="fa-regular fa-clipboard"></i>ORDER HISTORY</a></div>
