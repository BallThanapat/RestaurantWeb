                ...
                <div class="modal-body">
                    ...
                    <form id="form1">
                        ...
                        <div class="modal-footer d-flex justify-content-center">
                            ...
                            <button type="button" class="btn btn-success" id="btnlogin" onclick="gotologin('contractUs')">
                                Submit
                            </button>
                        </div>
                    </form>
                    ...
                    <form id="form2" style="display: none">
                        ...
                        <div class="modal-footer d-flex justify-content-center mt-3">
                            ...
                            <button onclick="gotosignup('contractUs')" type="button" class="btn btn-warning" id="btnsignup">
                                Submit
                            </button>
                        </div>
                    </form>
